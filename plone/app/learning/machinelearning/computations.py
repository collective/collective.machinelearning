...
class Learning(object):
    ...
    def _validate_schema(self):
        ...
        Returns None when parametres are correct. Returns an error string otherwise
        """
        if not os.path.exists(self.schema.modelsDir):
            return 'Directory path does not exist {}'.format(self.schema.modelsDir)
...
class Predict(object):
    ...
    def _validate_schema(self):
        ...
        Returns None when parametres are correct. Returns an error string otherwise
        """
        filepath = os.path.join(self.schema.modelsDir ,self.schema.clusteringFile)
