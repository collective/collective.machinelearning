...
class AutoSitemapView(BrowserView):
    ...
    """
    View for the Autositemap.
    Very much like the sitemap view but this is automatically learned.
...
class AutoLearnedViewlet(ViewletBase):
    ...
    def clustering(self):
        ...
        info['elements'] = filter(
            lambda br: br.getPath() != this_path, info['elements'])
        return info
